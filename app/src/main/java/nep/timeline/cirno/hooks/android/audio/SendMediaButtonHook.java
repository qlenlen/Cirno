...
public class SendMediaButtonHook {
  public SendMediaButtonHook(ClassLoader classLoader) {
    ...
    for (Method method : targetClass.getDeclaredMethods()) {
      ...
      if (methodName.equals("sendMediaButton")
          || methodName.equals("play")
          || methodName.equals("playFromMediaId")
          || methodName.equals("playFromSearch")
          || methodName.equals("playFromUri")
          || methodName.equals("next")
          || methodName.equals("previous")
          || methodName.equals("seekTo")) methods.add(method);
    }
            ...
            new AbstractMethodHook() {
              ...
              protected void beforeMethod(MethodHookParam param) {
                ...
                FreezerService.temporaryUnfreezeIfNeed(
                    XposedHelpers.getIntField(record, "mOwnerUid"), "按下媒体按键", 3000);
              }
            });
